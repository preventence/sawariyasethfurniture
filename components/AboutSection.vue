...
import { LeafIcon, HandshakeIcon, AwardIcon } from 'lucide-vue-next'

const values = [
  {
    title: 'Sustainably Sourced',
    icon: LeafIcon,
    desc: 'All timber from FSC-certified suppliers. We plant one tree for every piece we sell.',
  },
  {
    title: 'Lifetime Guarantee',
    icon: AwardIcon,
    desc: 'Structural defects covered for life. We stand behind every joint and finish.',
  },
  {
    title: 'Transparent Process',
    icon: HandshakeIcon,
    desc: 'Visit the workshop any time. Watch your piece being made, if you like.',
  },
]
</script>
